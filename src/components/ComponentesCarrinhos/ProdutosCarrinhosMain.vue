<template>
      <v-list-item class="bg-white my-6" elevation="0">
                    ...
                    <div class="w-50">
                        <v-list-item-title class="font-weight-medium" :title="produto.nome">
                            {{ produto.nome }}
                        </v-list-item-title>
                    ...
                    <div class="mr-15 d-flex flex-column">
                        ...
                        <v-btn variant="text" size="large" icon="mdi-chevron-right" @click="changeItemQuantity('add')" color="blue-lighten-1"/>
                        </div>
                    ...
                    <template v-slot:append>
                        <v-container class="align-left px-10" style="width: 150px;">
                            <p class="text-right font-weight-black">{{productvalor(produto)}}</p>
                        </v-container>
                    </template>
                    </v-list-item>
</template>
